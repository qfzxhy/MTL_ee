...
//	public static RunDetection runDetection= null;
	...
	public void find_information(String u) throws SQLException, ParseException, IOException{
		...
		//int newsId = dbtool.insertValuesxinhua(nInsert);
		/*
		 * add by qianf
		 */
...
//			return;
//		}
		int newsId = dbtool.selectMaxIdxinhua()+1;
		if(newsId>=0)
		{
			dbtool.deleteExcessXinhua("xinhua", newsId);
//			LabelItem extractResult = runDetection.GetEventInforfromNews("xinhua", String.valueOf(newsId), nInsert.getUpdateTime(), nInsert.getTitle());
//			extractResult.Print();
//			runDetection.labelDB.AddLabeltoTempTable(extractResult);
		}
		dbtool.insertValuesxinhua(nInsert);
	...
	public String getimageUrlpath(String s,String u) throws IOException{/*	获取图片并下载	*/
		...
		String newImagepath="xinhua_img/"+imageUrl.substring(imageUrl.lastIndexOf("/"));
...
//		http://www.xinhuanet.com/world/2018-03/18/c_1122553422.html
		xinhua x = new xinhua();
		try {
			x.find_information("http://www.xinhuanet.com/world/2018-03/18/c_1122553422.html");
